 ...
 *
 * `signals` is what `/start` matches a brief against — never shown on the site.
 * `direct` words name the service outright and score 2; `hints` are how someone
 * outside IT describes the problem ("takes hours", "keeps crashing") and score
 * 1. Write base forms: "copy" also catches "copies", "copied" and "copying".
 */
export const Services = [
  {
    ...
    signals: {
      direct: ["automate", "automation", "automatic", "automatically", "data entry"],
      hints: [
        "workflow",
        "repetitive",
        "manually",
  ...
  },
  {
    ...
    signals: {
      direct: ["pipeline", "etl", "database", "dashboard", "data warehouse"],
      hints: [
        "sync",
        "data",
        "excel",
  ...
  },
  {
    ...
    signals: {
      direct: ["chatbot", "bot", "virtual assistant", "ai assistant", "chatgpt"],
      hints: [
        "assistant",
        "agent",
        "answer",
  ...
  },
  {
    ...
    signals: {
      ...
      hints: ["site", "app", "google", "find us", "booking", "book online", "sell online"],
    },
  },
  {
    slug: "arts",
    title: "Arts & Graphic Design",
  ...
  },
  {
    ...
    signals: {
      direct: ["engine", "game", "simulation", "c++", "rust", "low-level"],
      hints: [
        "performance",
        "optimize",
        "optimise",
  ...
  },
  {
    ...
    signals: {
      direct: ["testing", "devops", "ci/cd", "code review", "deployment", "maintenance"],
      hints: [
        "deploy",
        "release",
        "refactor",
  ...
  },
  {
    ...
    signals: {
      direct: ["consulting", "consultant", "advice", "quote", "estimate"],
      hints: [
        "not sure",
        "no idea",
        "don't know",
...
/** The contact form's topics. Shared so the route can trust the label it emails. */
